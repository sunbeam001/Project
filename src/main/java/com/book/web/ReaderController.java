...
public class ReaderController {
    ...
    public String readerInfoAddDo(String register, String name, String sex, String birth, String address, String telcode, int readerId, RedirectAttributes redirectAttributes) {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        Date nbirth = new Date();
        try {
            java.util.Date date = sdf.parse(birth);
        ...
        if (succ && succc) {
            if ("1".equals(register)) {
                redirectAttributes.addFlashAttribute("msgSucc", "注册成功 ");
